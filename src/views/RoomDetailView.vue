        ...
        <div class="col-lg-8 col-md-8 padding-right-30">
          ...
          <div id="titlebar" class="listing-titlebar">
            <div class="listing-titlebar-title">
              <h2>{{ roomDetail.name }}<span class="listing-tag"></span></h2>
              <span>
                <a href="#listing-location" class="listing-address">
                  <i class="fa fa-map-marker"></i>
                  {{ roomDetail.province }},{{ roomDetail.country }}
                </a>
              </span>
          ...
          <div id="listing-overview" class="listing-section">
            ...
            <ul class="apartment-details">
              <li>{{ roomDetail.guests }} rooms</li>
              <li>{{ roomDetail.bedRoom }} bed</li>
...
export default {
  ...
  setup() {
    ...
    store.dispatch("reviews/getReviewListAction", route.params.roomId);
